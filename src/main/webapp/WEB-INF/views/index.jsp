...
border-width:1px;overflow:hidden;word-break:normal;border-color:#ccc;color:#333;background-color:#fff;}
...
<p>
${message}<br/>
<a	href="${pageContext.request.contextPath}/tasks">Click here to generate the Task List</a><br/>
</p>
</body>
</html>